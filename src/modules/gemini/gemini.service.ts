...
export class GeminiService {
  ...
  private getRandomMockRoast(): string {
    const roasts = [
      // Roast 1: Classic Friendly Roast
      `🔥 GitHub Roast 🔥
...
Keep up the good work, you'll be a senior developer in no time... give or take a decade! 🚀`,
      ...
      // Roast 3: Veteran Developer Roast
      `🔥 SENIOR DEV ROAST 🔥
...
They say less is more, and your GitHub proves it! 🎨`,
      ...
      // Roast 5: Language Specialist Roast
      `🔥 POLYGLOT PROGRAMMER 🔥
...
Keep exploring, you linguistic legend! 🌍💻`,
      ...
      // Roast 6: Inactive Account Roast
